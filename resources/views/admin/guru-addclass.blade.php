            ...
            <div class="addclass-box dashboard-box">
                ...
                <form action="{{route('course.store')}}" class="dashboard-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="addclass-input-grup dashboard-input-grup">
                        <label for="nama_karanganbunga">nama karanganbunga</label>
                        <input class="w-100" type="text" name="nama_karanganbunga" id="title" value="" placeholder="Enter course title" required>
                    </div>
                    <div class="addclass-input-grup dashboard-input-grup">
                        <label for="kode_karanganbunga">kode karanganbunga</label>
                        <input class="w-100" type="text" name="kode_karanganbunga" id="title" value="" placeholder="Enter Skill Level"
                            required>
                    </div>
                    <div class="addclass-input-grup dashboard-input-grup">
