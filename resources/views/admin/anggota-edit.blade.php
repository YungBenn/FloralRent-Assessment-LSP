...
<body>
    <div class="app">
        ...
        <div class="dashboard addclass">
            ...
            <form class="dashboard-form" action="{{ route('anggota.update', $user->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="addclass-input-grup dashboard-input-grup">
                    <label for="name">Nama Anggota</label>
                    <input class="w-100" type="text" name="name" id="title" value="{{$user->name}}" placeholder="Masukkan Nama Anggota">
                </div>
                <div class="addclass-input-grup dashboard-input-grup">
                    <label for="email">Email</label>
                    <input class="w-100" type="text" name="email" id="title" value="{{$user->email}}" placeholder="Masukkan Email Anggota">
                </div>
                <div class="addclass-input-grup dashboard-input-grup">
                    <label for="no_telp">No Telp</label>
                    <input class="w-100" type="text" name="no_telp" id="title" value="{{$user->no_telp}}" placeholder="Masukkan notelp Anggota">
                </div>
                <div class="addclass-input-grup dashboard-input-grup">
                ...
                <div class="addclass-input-grup dashboard-input-grup">
                    ...
                    <input class="w-100" type="text" name="password" id="password" min="0" max='200000' value=""
