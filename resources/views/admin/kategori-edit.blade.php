    ...
    <div class="app">
        ...
        <div class="dashboard addclass">
            ...
            <div class="addclass-box dashboard-box">
                ...
                <form action="{{route('kategori.update',$kategori->id)}}" class="dashboard-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="addclass-input-grup dashboard-input-grup">
                        ...
                        <input class="w-100" type="text" name="nama" id="title" value="{{$kategori->nama}}" placeholder="Ketik nama kategori" required>
                    </div>
                    <!-- tombol submit -->
